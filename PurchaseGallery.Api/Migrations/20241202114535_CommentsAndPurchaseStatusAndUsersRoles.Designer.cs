...
namespace PurchaseGallery.Api.Migrations
{
    ...
    [Migration("20241202114535_CommentsAndPurchaseStatusAndUsersRoles")]
    partial class CommentsAndPurchaseStatusAndUsersRoles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PurchaseGallery.Api.Models.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PurchaseGallery.Api.Models.Notifications.Notifications", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PurchaseGallery.Api.Models.PurchaseRequests.PurchaseRequestStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PurchaseRequestsStauts");
                });
            ...
            modelBuilder.Entity("PurchaseGallery.Api.Models.Comments.Comment", b =>
                {
                    b.HasOne("PurchaseGallery.Api.Models.Comments.Comment", null)
                        .WithMany("Replies")
                        .HasForeignKey("CommentId");

                    b.HasOne("PurchaseGallery.ApiService.Models.Auth.User", "Commenter")
                        .WithMany()
            ...
            modelBuilder.Entity("PurchaseGallery.Api.Models.PurchaseRequests.Approval", b =>
                {
                    ...
                    b.HasOne("PurchaseGallery.Api.Models.PurchaseRequests.PurchaseRequestStatus", "Status")
                        .WithMany()
